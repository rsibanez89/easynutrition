						...
						<form role="form">
							...
							<div class="form-group">
								<label>Inline Checkboxes Examples</label> <label
									class="checkbox-inline"> <input type="checkbox" /> One
							...
							<div class="form-group">
								...
								<div class="radio">
									<label> <input type="radio" name="optionsRadios"
										id="optionsRadios1" value="option1" checked />Radio Example
										One
									</label>
								</div>
								<div class="radio">
	...
	<div class="col-md-12">
		...
		<p>
			...
			visit official bootstrap website i.e getbootstrap.com or <a
				...
				here</a> . We hope you will enjoy our template. This template is easy to
